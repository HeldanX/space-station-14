id-card-console-window-privileged-id = ID privilegiato:
id-card-console-window-target-id = ID obiettivo:
id-card-console-window-full-name-label = Nome completo:
id-card-console-window-save-button = Salva
id-card-console-window-job-title-label = Titolo di lavoro:
id-card-console-window-eject-button = Espelli
